...
# cover
# path1 = './datasets/BOSS_BOWS2/jpg-mat/bb_256_qf%s'%(QF)
# path2 = './datasets/BOSS_BOWS2/jpg-mat/jpeg2spatial/bb_256_qf%s'%(QF)

# stego
path1 = './datasets/BOSS_BOWS2/jpg-mat/bb_256_qf%s_uerd04'%(QF)
path2 = './datasets/BOSS_BOWS2/jpg-mat/jpeg2spatial/bb_256_qf%s_uerd04'%(QF)
